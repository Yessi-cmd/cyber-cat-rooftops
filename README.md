...
当前视觉切片已经通过四个目标视口检查；代码原生像素动画已覆盖待机、跑动、上升、顶点、下落、落地和失败，确定性屋顶模块已包含屋檐边帽、通风口、天线、水箱和可关闭蒸汽。发布视觉包含统一像素控制图标、标题锁定组合、favicon 与 1200×630 Open Graph 卡；程序化环境音、连续三局帧采样、三次 180 秒长局资源边界测试均已完成。校准参数和实机检查方法见 [试玩记录](docs/PLAYTEST.md)。
